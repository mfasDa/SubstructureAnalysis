...
void makePlotJetSpectrumPOWHEGWIP(int R = 2, const std::string_view spectrumfile = "jetspectrum.root" , const std::string_view powhegfile = "POWHEGv1.root") {
    ...
    auto prelimlabel = new ROOT6tools::TNDCLabel(0.39, 0.72, 0.94, 0.92, "ALICE work in progress");
