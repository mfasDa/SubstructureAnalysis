...
void runCorrectionChain1DBayes_SpectrumTaskSimplePoor_CorrectEffPure(const std::string_view datafile, const std::string_view mcfile, const std::string_view sysvar = "", int radiusSel = -1, bool doMT = false){
