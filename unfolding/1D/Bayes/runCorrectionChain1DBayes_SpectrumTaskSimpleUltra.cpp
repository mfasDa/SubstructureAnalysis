...
void runCorrectionChain1DBayes_SpectrumTaskSimpleUltra(const std::string_view datafile, const std::string_view mcfile, int ultraoption, const std::string_view sysvar = ""){
    ...
    outputfile << "correctedBayes_ultra" << ultraoption;
    if(sysvar.length()) {
        outputfile << "_" << sysvar;
    }
    outputfile << ".root";
