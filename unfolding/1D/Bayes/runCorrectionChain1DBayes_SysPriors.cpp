...
void runCorrectionChain1DBayes_SysPriors(double radius, const std::string_view option, const std::string_view indatadir = ""){
    ...
    TH1 *responseweight(nullptr);
    {
        ...
        priorfile << "/data1/mfasel/Fulljets/pp_13TeV/Substructuretree/data_mc/20180620_corr2017/corrected_1D/default/corrected1DBayes_R" << std::setw(2) << std::setfill('0') << int(radius*10.) << ".root";
