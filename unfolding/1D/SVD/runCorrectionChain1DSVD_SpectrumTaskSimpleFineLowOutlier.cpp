...
void runCorrectionChain1DSVD_SpectrumTaskSimpleFineLowOutlier(const std::string_view datafile, const std::string_view mcfile, const std::string_view sysvar = ""){
