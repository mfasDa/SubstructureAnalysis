...
void runCorrectionChain1DSVD_SpectrumTaskSimplePoor_SysTrigger(const std::string_view datafile, const std::string_view mcfile, double triggerscale, const std::string_view sysvar = ""){
