...
void RunUnfoldingZgSys_truncation(const std::string_view filedata, const std::string_view filemc, const std::string_view systematic, double fracSmearClosure = 0.5){
