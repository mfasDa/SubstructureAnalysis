...
void RunUnfoldingZg_weightedClosure(const std::string_view filedata, const std::string_view filemc, const std::string_view sysoption, double fracSmearClosure = 0.5){
