...
std::vector<double> getJetPtBinningNonLinSmearMinBias5TeV(){
  binninghelper binning(10., {{130., 5.}});
  return binning.CreateCombinedBinning();
}
...
std::vector<double> getJetPtBinningNonLinTrueMinBias5TeV(){
  binninghelper binning(0., {{20., 20.}, {80., 10.}, {140., 20.}, {300., 160.}});
  return binning.CreateCombinedBinning();
}
