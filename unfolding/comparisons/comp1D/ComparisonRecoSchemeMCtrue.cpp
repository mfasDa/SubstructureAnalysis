...
void ComparisonRecoSchemeMCtrue(int ultraoption, const std::string_view sysvar){
    std::stringstream basefile, plotname;
    basefile << "correctedSVD";
    plotname << "comparisonRecoSchemeMCtrue";
    if(ultraoption > -1){
    ...
    basefile << ".root";
    std::vector<std::string> branchlist = {"truetrunc"};
    ...
    for(auto radius : radii) {
        ...
        specescheme->Scale(1./(40e6), "width");
        specptscheme->Scale(1./(40e6), "width");
