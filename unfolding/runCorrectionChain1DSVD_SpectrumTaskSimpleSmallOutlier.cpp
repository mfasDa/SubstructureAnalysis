...
void runCorrectionChain1DSVD_SpectrumTaskSimpleSmallOutlier(const std::string_view datafile, const std::string_view mcfile, const std::string_view sysvar = ""){
    ...
    auto binningpart = getJetPtBinningNonLinTrue(),
         binningdet = getJetPtBinningNonLinSmear();
