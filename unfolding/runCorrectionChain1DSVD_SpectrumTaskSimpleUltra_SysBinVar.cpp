...
void runCorrectionChain1DSVD_SpectrumTaskSimpleUltra_SysBinVar(const std::string_view datafile, const std::string_view mcfile, int ultraoption, const std::string_view binvar, const std::string_view sysvar = ""){
    ...
    outputfile << "correctedSVD_ultra" << ultraoption << "_binvar" << binvar;
    if(sysvar.length()) {
        outputfile << "_" << sysvar;
    }
    outputfile << ".root";
