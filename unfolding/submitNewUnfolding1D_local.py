...
if __name__ == "__main__":
    ...
    parser.add_argument("datafile2018", metavar="DATFILE2018", type=str, help="Data input from 2018")
    ...
    unfoldingexecutable = os.path.join(repo, "runNewUnfolding1D_local.sh")
