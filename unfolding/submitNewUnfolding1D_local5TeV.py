...
def main():
    ...
    parser.add_argument("-m", "--macro", metavar="MACRO", type=str, default="runNewCorrectionChainMBonly1DSVD5TeV_SpectrumTaskSimplePoor_CorrectEffPure.sh", help="Unfolding macro")
