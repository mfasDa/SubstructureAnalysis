...
def create_jobscript(workdir, observable, radius, datafile, mcfile):
    ...
    with open(jobscriptname, "w") as jobscriptwriter:
        ...
        jobscriptwriter.write("export ALIBUILD_WORK_DIR=/clusterfs1/markus/alice/sw\n")
        jobscriptwriter.write("eval `alienv --no-refresh printenv AliPhysics/latest-ali-master-root6`\n")
