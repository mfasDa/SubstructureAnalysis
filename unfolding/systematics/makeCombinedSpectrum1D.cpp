...
void makeCombinedSpectrum1D(const char *correlatedSys, const char *shapeSys) {
    ...
    for(auto r : ROOT::TSeqI(2, 7)){
        ...
        auto spechist = reported(static_cast<TH1 *>(gDirectory->Get(Form("Specdefault_%s", rstring.data()))));
