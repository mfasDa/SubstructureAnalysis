...
void makePlotCorrelatedUncertaintiesPt1D(const std::string_view ufile){
    Restrictor reported(20, 320);
    auto plot = new ROOT6tools::TSavableCanvas("correlatedUncertaintiesSpectrum", "Correlated Uncertainties", 1200, 800);
    plot->Divide(3,2);
