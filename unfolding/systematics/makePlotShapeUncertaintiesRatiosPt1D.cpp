...
void makePlotShapeUncertaintiesRatiosPt1D(const std::string_view ufile){
    Restrictor reported(15, 320);
    auto plot = new ROOT6tools::TSavableCanvas("shapeUncertaintiesRatios", "Shape Uncertainties", 1200, 800);
    plot->Divide(2,2);
